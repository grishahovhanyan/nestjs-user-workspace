...
export const ERROR_MESSAGES = {
  ...
  workspaceAlreadyExists: 'Workspace with such slug already exists.',
  invitationDeclined: 'Invitation already declined.',
  invitationAccepted: 'Invitation already accepted.',
  userAlreadyInvited: 'User with such id already invited.'
}
